...
export default function App() {
  ...
  function handleAddWatched(movie) {
    ...
    // localStorage.setItem("watched", JSON.stringify([...watched, movie])); // if updated here, need to again update when movie is deleted
  }
  ...
  useEffect(
    ...
    [watched]
  ); // will auto update whenever watched is updated
